 ...
 *********************************************************************** */
{
  ...
  phi_rad = g_inputParam[PHI_DEGREES] * 0.0174533;
  ...
  inside_phi = blob_x2 < phi_rad;

  //params for gaussian density
  
  

  if (inside_blob * inside_phi){ //INSIDE THE SHELL
