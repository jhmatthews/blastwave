...
print (R0, blast_wave_util.UNIT_LENGTH)
rho_ism = n0 * MPROT    
volume = omega * R0 * R0 * R0 / 3.0
...
print_helper("M0 from E0:", M0)
print_helper("Miso", Miso)
print_helper("E0", E0)
print_helper("Eiso", Eiso)
print_helper("volume", volume / omega)
...
print_helper("rho_blob_lab_frame:", rho_blob)
print_helper("rho_blob_rest_frame:", rho_blob / gamma0)
